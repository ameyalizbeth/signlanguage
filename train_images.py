...
with open("train_images_groupNMS", "wb") as f:
	pickle.dump(train_images, f)
del train_images

train_labels = labels[:int(5/6*len(labels))]
print("Length of train_labels", len(train_labels))
with open("train_labels_groupNMS", "wb") as f:
...
with open("val_images_groupNMS", "wb") as f:
	pickle.dump(val_images, f)
del val_images

val_labels = labels[int(5/6*len(images)):]
print("Length of val_labels", len(val_labels))
with open("val_labels_groupNMS", "wb") as f:
